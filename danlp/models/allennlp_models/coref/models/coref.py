...
from danlp.models.allennlp_models.coref.metrics.conll_coref_scores import ConllCorefScores
from danlp.models.allennlp_models.coref.metrics.mention_recall import MentionRecall
...
class CoreferenceResolver(Model):
    ...
    desc_dropout :  dropout rate for the description embeddings
    """
    ...
    def forward(
        ...
        metadata : `List[Dict[str, Any]]`, optional (default = `None`).
            ...
            clusters for that instance. Description embeddings are stored here as well.
        ...
        #import pdb; pdb.set_trace()
        # Shape: (batch_size, num_spans, 2 * encoding_dim + desc_emb_size + feature_size)
